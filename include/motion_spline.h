...
class MotionSpline{
  ...
  public:
    ...
    void Motion(RobotCmd &cmd, double time,RobotData &data_state, float kp, float kd, double motion_time);
    ...
    /// @param kp Proportional gain of joint controller
    /// @param kd Derivative gain of joint controller
    void SwingToAngle(Vec3 initial_angle, Vec3 final_angle, double total_time, double run_time, double cycle_time, string side, RobotCmd &cmd,  RobotData &data, float kp, float kd);
